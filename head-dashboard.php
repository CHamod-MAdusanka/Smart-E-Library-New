...
<body>
        ...
        <div class="header-right">
            ...
            <div class="dropdown">
                <button class="profile-btn" onclick="toggleDropdown('profile-dropdown')"> 
                    ...
                    <span id="header-profile-name">Chamod Perera</span>
                </button>               
    ...
    <div class="dashboard-container">        
        <div id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="menu-item">Manage Staff ▾
                    <ul class="submenu">
                        <li onclick="showSection('view-officers')"> View Officers</li>
                        <li onclick="showSection('add-officer')"> Add Officer </li>
                        <li onclick="showSection('remove-officer')"> Remove Officer</li>
                    </ul>
                </li>
        ...
        <div class="main-content" id="main-display-area">            
                ...
                <div class="add-officer-panel">
                    <div class="add-officer-card">
                        <div class="table-card">
                            <table class="styled-table">
                                <thead>
                                    <tr><th>Work ID</th><th>Full Name</th><th>Email</th></tr>
                                </thead>
                            <tbody id="view-officers-body">
                            </tbody>
                            </table>
                        </div>
                    </div>
            ...
            <div id="add-officer" class="dynamic-section section-hidden">
                ...
                <div class="add-officer-panel">
                    <div class="add-officer-card add-officer-form"> 
                        <div class="field-grid form-grid-2-col">
                            <div class="field-item">
                                <label class="form-label">First Name</label>
                                <input type="text" id="add-officer-fname" class="form-input" placeholder="e.g. Chamod">
                            </div>
                            <div class="field-item">
                                <label class="form-label">Last Name</label>
                                <input type="text" id="add-officer-lname" class="form-input" placeholder="e.g. Madushanka">
                            </div>
                            <div class="field-item">
                                <label class="form-label">Email Address</label>
                                <input type="email" id="add-officer-email" class="form-input" placeholder="chamod@library.com" autocomplete="off">
                            </div>
                            <div class="field-item">
                                <label class="form-label">Assign Work ID</label>
                                <input type="text" id="add-officer-id" class="form-input" placeholder="e.g. LIB-001">
                            </div>
                            <div class="field-item field-full">
                                <label class="form-label">Temporary Password</label>
                                <input type="password" id="add-officer-password" class="form-input" placeholder="Create a strong temporary password" autocomplete="new-password">
                            </div>
                        </div>
                        <button type="button" class="btn-save btn-full-width" onclick="createNewOfficer()">+ Create Officer Account</button>
                    </div>
                </div>
                ...
                <div class="directory-panel">
                    ...
                    <div class="table-card">
                        <table class="styled-table">
                            ...
                            <tbody id="active-officers-directory-body">
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="add-officer-panel">
                    <div class="add-officer-card">
                        <div class="table-card">
                            <table class="styled-table">
                                <thead>
                                    <tr><th>Work ID</th><th>Full Name</th><th>Email</th><th>Action</th></tr>
                                </thead>
                                <tbody id="remove-officer-body">
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="add-officer-card">
                        <div class="table-card">
                            <table class="styled-table">
                                ...
                                <tbody id="all-students-body"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                ...
                <div class="add-officer-panel">
                    <div class="add-officer-card">
                        <div class="table-card">
                            <table class="styled-table">
                                <thead>
                                    <tr><th>Student</th><th>Full Name</th><th>Email</th><th>Action</th></tr>
                                </thead>
                ...
                <div class="directory-panel">
                    ...
                    <div class="table-card">
                        <table class="styled-table" id="book-inventory-table">
                            <thead>
                                <tr><th>Cover</th><th>Book ID</th><th>Title</th><th>Author</th><th>Category</th><th>QR Code</th></tr>
                            </thead>
                            <tbody></tbody>
                        </table>
                    </div>
                ...
                <div class="directory-panel">
                    ...
                    <div class="table-card">
                        <table class="styled-table" id="remove-book-table">
                            <thead>
                                <tr><th>Cover</th><th>Book ID</th><th>Book Title</th><th>Author</th><th>Action</th></tr>
                            </thead>
                            <tbody id="remove-book-body"></tbody>
                        </table>
                    </div>
                </div>
            </div>
                ...
                <div class="add-officer-panel">
                    <div class="add-officer-card">
                        <div class="table-card">
                            <table class="styled-table">
                                <thead>
                                    <tr><th>Student Name</th><th>Book Title</th><th>Reserved Date</th><th>Status</th><th>Action</th></tr>
                                </thead>
                ...
                <div class="settings-grid">
                    <div class="settings-card">
                        ...
                        <div style="text-align: center; margin-top: 15px; margin-bottom: 25px;">
                            <img id="settings-profile-preview" src="static/chamod.png" alt="Profile Preview" style="width: 110px; height: 110px; border-radius: 50%; border: 4px solid #3b82f6; object-fit: cover; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                            <h4 style="margin: 12px 0 0 0; color: #0f172a; font-size: 16px; font-weight: 700;">System ID: <span id="settings-profile-id" style="color: #64748b; font-weight: normal;">HEAD001</span></h4>
                        </div>
                        ...
                        <div class="form-style" style="margin-top: 15px;">
                            <div style="margin-bottom: 12px;">
                                ...
                                <input type="text" id="profile-name-input" class="filter-input" style="max-width:100%; width:90%;" value="Chamod Perera">
                            </div>
                            <div style="margin-bottom: 12px;">
                                <label style="font-weight:bold; display:block; margin-bottom:5px;">Email Address</label>
                                <input type="email" id="profile-email-input" class="filter-input" style="max-width:100%; width:90%;" value="admin@elibrary.com">
                            </div>
                            ...
                            <div id="pw-step-2" style="display: none; background: #f8fafc; padding: 18px; border-radius: 8px; border: 1px solid #e2e8f0; margin-top: 10px;">
                                ...
                                <input type="password" id="pw-new" class="filter-input" style="max-width:100%; width:100%; margin-bottom: 12px; box-sizing: border-box;" placeholder="Create new password">
                                <label style="font-weight:bold; display:block; margin-bottom:8px; color: #0f172a;">Confirm New Password</label>
                                <input type="password" id="pw-confirm" class="filter-input" style="max-width:100%; width:100%; margin-bottom: 20px; box-sizing: border-box;" placeholder="Retype new password">
                                <div style="display: flex; gap: 10px;">
                    ...
                    <div class="settings-card">
                        ...
                        <div class="form-style" style="margin-top: 15px;">
                            <div style="margin-bottom: 12px;">
                                ...
                                <input type="number" id="pref-days" class="filter-input" style="max-width:100%; width:90%;" value="14">
                            </div>
                            <div style="margin-bottom: 15px;">
                    ...
                    <div class="settings-card danger-zone-card">
                        ...
                        <div style="margin-bottom: 15px;">
                            <select id="transfer-officer-select" class="filter-select" style="width:100%;">
                                <option value="">-- Choose Active Officer --</option>
                            </select>
                        </div>
                        <div class="modal-actions" style="justify-content: flex-start; gap: 10px;">
                            <button class="btn-secondary" onclick="executeOwnershipTransfer()">Transfer Ownership</button>
                            <button class="btn-danger" id="btn-delete-account" onclick="executeAccountDeletion()" style="opacity:0.5;">Delete Account</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="profile-auth-modal" class="modal-overlay">
        <div class="modal-content">
            ...
            <input id="profile-auth-password" class="modal-input" type="password" placeholder="Current Password">
